import pygame
NEIGHBOR_OFFSETS  = [(-1,0),(-1,-1),(0,-1),(1,-1),(1,0),(0,0),(-1,1),(0,1),(1,1)] # We use this for colliosn detections "current tile ke aas-paas ke sab positions"
...
class Tilemap:
    ...
    def tiles_around(self,pos):
        tiles =[]
        tile_loc = (int(pos[0] // self.tile_size), int(pos[1] // self.tile_size)) # we do this bcz pos is a pixel pos and grid_tiles are non-pixels so we have to convert pixel position into grid position
